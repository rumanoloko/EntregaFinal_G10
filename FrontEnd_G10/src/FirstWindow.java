...
public class FirstWindow extends JFrame implements Serializable {
    ...
    private JTextField introducirPeso;
    private JTextField introducirHub;
    private JButton pesoMinimoBoton;
    private Carguero c;
    ...
    public FirstWindow() throws IOException, ClassNotFoundException {
        ...
        pesoMinimoBoton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                if(introducirPeso.getText()!=null && introducirHub.getText()!=null){

                    String s= c.PesoMinimo(Double.parseDouble(introducirPeso.getText()),Integer.parseInt(introducirPeso.getText()));
                    new ThirdWindow(s);
                }
